...
void writeChunk(Chunk* chunk, uint8_t byte, int line) {
    if (chunk->capacity < (chunk->count + 1)) {
        ...
        chunk->lines = (int*)reallocate(chunk->lines, sizeof(int) * (oldCapacity), sizeof(int) * (chunk->capacity));
    }
